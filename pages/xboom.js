...
export default function Xboom() {
  ...
  const greetings = [
    getCardGreeting("xboom-0"),
    getCardGreeting("xboom-1"),
    getCardGreeting("xboom-2"),
    getCardGreeting("xboom-3"),
    getCardGreeting("xboom-4"),
  ];
            ...
            <button
              onClick={() => {
                if (selectedCardIndex !== null) {
                  const cardId = getCardId("xboom", selectedCardIndex);
