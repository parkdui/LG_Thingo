...
export default function Puricare() {
  ...
  const greetings = [
    getCardGreeting("puricare-0"),
    getCardGreeting("puricare-1"),
    getCardGreeting("puricare-2"),
    getCardGreeting("puricare-3"),
  ];
  ...
  return (
    <>
      <Head>
        <title>Puricare - Thingo App</title>
        <meta name="description" content="Puricare page" />
            ...
            <button
              onClick={() => {
                if (selectedCardIndex !== null) {
                  const cardId = getCardId("puricare", selectedCardIndex);
